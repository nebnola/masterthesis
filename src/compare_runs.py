...
def compare_runs(filenames: Mapping | Iterable, directory="") -> pd.DataFrame:
    """
    ...
    Args:
        filenames: Either a filename:label mapping or an iterable of filenames. In the second case, the filename
            itself is used as the label. The label is used in the "method" column of the returned data frame.
